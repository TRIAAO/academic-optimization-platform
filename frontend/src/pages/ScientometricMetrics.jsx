        ...
        <>
          <section>
            ...
            <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              <MetricCard
                title="Citações"
                value={formatNumber(latestMetric.citationsTotal)}
              ...
              <MetricCard
                title="H-index"
                value={formatNumber(latestMetric.hIndexTotal)}
              ...
              <MetricCard
                title="i10-index"
                value={formatNumber(latestMetric.i10IndexTotal)}
              ...
              <MetricCard
                title="D-index"
                value={formatNumber(latestMetric.dIndex)}
